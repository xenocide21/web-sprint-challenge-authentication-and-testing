...
A: sessions stores the hashed password in your local storage, JWT stores the token in cookies
2. What does `bcrypt` do to help us store passwords in a secure manner.
A: it encrypts the password into a long string of random letters and numbers
3. How are unit tests different from integration and end-to-end testing.
A: unit tests one thing individually, integration tests how multiple pieces of code works together
4. How _Test Driven Development_ changes the way we write applications and tests.
A: test driven development can be a useful practice because writing the test before you write the code ensures you have to write code that will pass the test and conform to the requirements.
